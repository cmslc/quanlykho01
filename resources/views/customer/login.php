...
<head>
    ...
    <title><?= $ToryHub->site('title') ?> - <?= __('Đăng nhập Khách Hàng') ?></title>
...
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-md-5 col-lg-4">
                    <div class="card auth-card">
                        <div class="card-body p-4">
                            <div class="text-center mb-4">
                                ...
                                <h4 class="mb-1"><b>Khách Hàng - ToryHub</b></h4>
                                <p class="text-muted fs-13"><?= __('Cổng khách hàng') ?></p>
                            </div>
                            ...
                            <div class="mt-4 text-center">
                                <p class="mb-2"><?= __('Chưa có tài khoản?') ?>
                                    <a href="<?= base_url('customer/register') ?>" class="fw-semibold text-primary"><?= __('Đăng ký') ?></a>
                                </p>
                                <a href="<?= base_url('customer/tracking') ?>" class="text-muted">
                                    <i class="ri-search-line"></i> <?= __('Tra cứu đơn hàng (không cần đăng nhập)') ?>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-2 mt-3">
                        ...
                        <a href="<?= base_url('customer/login') ?>" class="btn btn-light btn-sm active disabled">
    ...
    $('#form-login').on('submit', function(e){
        ...
        $.ajax({
            url: '<?= base_url('ajaxs/customer/login.php') ?>',
            type: 'POST',
            data: $(this).serialize(),
            dataType: 'json',
