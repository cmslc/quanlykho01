        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <a href="<?= base_url('admin/transactions-add') ?>" class="btn btn-primary">
                    ...
                    <div class="card-body">
                        <form method="GET" action="<?= base_url('admin/transactions') ?>" class="row g-3 align-items-end">
                            ...
                            <div class="col-md-3">
                                ...
                                <a href="<?= base_url('admin/transactions') ?>" class="btn btn-secondary"><?= __('Reset') ?></a>
                            </div>
                        </form>
                    </div>
                </div>
                            ...
                            <table class="table data-table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?= $txn['id'] ?></td>
                                        <td>
                                            <a href="<?= base_url('admin/customers-detail&id=' . $txn['customer_id']) ?>"><?= htmlspecialchars($txn['customer_code'] ?? '') ?></a>
...
$('#btnSaveTxn').on('click', function(){
    ...
    $.post('<?= base_url('ajaxs/admin/transactions.php') ?>', {
        request_name: 'edit',
        id: $('#editTxnId').val(),
