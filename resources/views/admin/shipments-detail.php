                            ...
                            <table class="table table-hover mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?= __('Khách hàng') ?></th>
                                        <th class="text-center"><?= __('Số kiện') ?></th>
                                        <th class="text-end"><?= __('Tổng cân') ?></th>
                                        <th class="text-end"><?= __('Tổng khối') ?></th>
                                        <th><?= __('Trạng thái') ?></th>
                                        <?php if ($isPreparing): ?>
                                        <th></th>
                                        <?php endif; ?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if ($group['is_bag']): ?><span class="badge bg-info-subtle text-info"><?= __('Hàng lẻ') ?></span><?php else: ?><span class="badge bg-warning-subtle text-warning"><?= __('Hàng lô') ?></span><?php endif; ?></td>
                                        ...
                                        <td><?= htmlspecialchars($group['customer']) ?></td>
                                        <td class="text-center">
                                        ...
                                        <td class="text-end"><?= $totalW > 0 ? fnum($totalW, 2) . ' kg' : '' ?></td>
                                        <td class="text-end"><?= $totalCbm > 0 ? fnum($totalCbm, 2) . ' m³' : '' ?></td>
                                        <td>
