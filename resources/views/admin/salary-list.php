                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr><td colspan="12" class="text-center text-muted py-4"><?= __('Chưa có bảng lương tháng này. Bấm "Tạo bảng lương tháng" để bắt đầu.') ?></td></tr>
                                    <?php endif; ?>
                                    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex gap-1 justify-content-center">
                                                ...
                                                <a href="<?= base_url('admin/salary-detail?id=' . $s['id']) ?>" class="btn btn-sm btn-soft-primary" title="<?= __('Sửa') ?>"><i class="ri-edit-line me-1"></i><?= __('Sửa') ?></a>
