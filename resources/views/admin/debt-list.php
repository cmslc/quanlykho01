                            ...
                            <table class="table data-table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?= $stt ?></td>
                                        <td>
                                            <a href="<?= base_url('admin/customers-detail?id=' . $dc['id']) ?>" class="fw-medium">
                                                <?= htmlspecialchars($dc['fullname']) ?>
                                            </a>
                                        </td>
                                        ...
                                        <td class="text-end"><span class="badge bg-danger fs-12"><?= format_vnd($dc['debt']) ?></span></td>
                                    </tr>
                                    <?php endforeach; ?>
