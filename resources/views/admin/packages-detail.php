                            ...
                            <table class="table table-sm mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('admin/orders-detail?id=' . $ord['id']) ?>" class="btn btn-sm btn-soft-info"><i class="ri-eye-line me-1"></i><?= __('Xem') ?></a>
                                            <button class="btn btn-sm btn-soft-danger btn-unlink" data-order-id="<?= $ord['id'] ?>" data-code="<?= $ord['order_code'] ?>"><i class="ri-link-unlink me-1"></i><?= __('Gỡ') ?></button>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
