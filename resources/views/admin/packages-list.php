...
$pkgStatuses = ['pending', 'cn_warehouse', 'packed', 'loading', 'shipping', 'vn_warehouse', 'delivered'];
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="d-flex flex-wrap gap-2">
                    ...
                    ?>
                    <a href="<?= base_url('admin/packages-list?status=' . $s) ?>" class="text-decoration-none flex-fill" style="min-width:120px;">
                        <div class="card card-animate mb-0 <?= $filterStatus == $s ? 'border border-primary' : '' ?>">
                            <div class="card-body py-2 px-2 text-center">
                                <h5 class="mb-0"><?= $cnt ?></h5>
                                <small class="text-muted" style="font-size:11px;"><?= display_package_status($s) ?></small>
                            </div>
                        </div>
                    </a>
                    <?php endforeach; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-1">
                                                <a href="<?= base_url('admin/packages-detail?id=' . $pkg['id']) ?>" class="btn btn-sm btn-soft-info"><i class="ri-eye-line me-1"></i><?= __('Xem') ?></a>
                                                <button class="btn btn-sm btn-soft-danger btn-delete" data-id="<?= $pkg['id'] ?>" data-code="<?= htmlspecialchars($pkg['package_code']) ?>"><i class="ri-delete-bin-line me-1"></i><?= __('Xóa') ?></button>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
