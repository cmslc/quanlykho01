        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0"><?= __('Sửa khách hàng') ?>: <?= htmlspecialchars($customer['customer_code']) ?></h4>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex justify-content-between">
                                <span><?= __('Công nợ') ?></span>
                                <span class="<?= $customer['balance'] < 0 ? 'text-danger fw-bold' : 'text-success' ?>"><?= format_vnd($customer['balance']) ?></span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
