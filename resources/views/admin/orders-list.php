        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <a href="<?= base_url('admin/' . $_currentAction . '&status=' . $s) ?>" class="text-decoration-none flex-fill" style="min-width:120px;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($isRetail): ?>
                                                ...
                                                ?>
                                                <a href="<?= base_url('admin/orders-detail?id=' . $order['id']) ?>">
                                        ...
                                        <td>
                                            <div class="d-flex gap-1">
                                                <a href="<?= base_url('admin/orders-detail?id=' . $order['id']) ?>" class="btn btn-sm btn-soft-info"><i class="ri-eye-line me-1"></i><?= __('Xem') ?></a>
                                                <a href="<?= base_url('admin/orders-edit?id=' . $order['id']) ?>" class="btn btn-sm btn-soft-warning"><i class="ri-pencil-line me-1"></i><?= __('Sửa') ?></a>
            ...
            if (res.status === 'success') {
                ...
                groups.forEach(function(group){
                    ...
                    if (pkgs.length === 1) {
                        ...
                        html += '<td>' + (first.weight_actual > 0 ? fnum(totalW, 2) + ' kg' : '-') + '</td>';
                        html += '<td>' + dim + '</td>';
                        html += '<td>' + (first.cbm > 0 ? fnum(totalC, 2) + ' m³' : '-') + '</td>';
                        html += '<td>' + (statusLabels[first.status] || first.status) + '</td>';
                        html += '</tr>';
