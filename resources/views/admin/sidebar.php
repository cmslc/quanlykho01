...
$sidebarMenu = [
    ...
    [
        ...
        'active' => ['transactions', 'transactions-add', 'finance-summary', 'debt-list', 'salary-list', 'salary-detail', 'shipping-calculator', 'expenses'],
        'children' => [
            ...
            ['label' => __('Công nợ'),           'url' => base_url('admin/debt-list'),             'active' => ['debt-list']],
    ...
    [
        ...
        'active' => ['reports', 'reports-revenue', 'reports-customers'],
        'children' => [
            ['label' => __('Doanh thu & Đơn hàng'), 'url' => base_url('admin/reports-revenue'),   'active' => ['reports-revenue']],
