                        ...
                        <form method="GET" action="<?= base_url('admin/expenses') ?>">
                            <div class="row g-3 align-items-end">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="<?= base_url('admin/expenses') ?>" class="btn btn-sm btn-outline-secondary"><?= __('Reset') ?></a>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body py-2">
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            ?>
                            <a href="<?= base_url('admin/expenses&month='.$filterMonth.'&year='.$filterYear.'&category='.urlencode($cs['category'])) ?>"
