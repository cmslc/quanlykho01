            ...
            <div class="col-xl-7">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <form method="GET" action="<?= base_url('admin/expenses') ?>" class="d-flex gap-2 align-items-center">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0 align-middle">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <tr class="<?= $isActive ? 'table-active fw-bold' : '' ?>" style="cursor:pointer" onclick="location.href='<?= base_url('admin/expenses&month='.$ms['m'].'&year='.$ms['y']) ?>'">
                                        <td><?= $ms['m'] ?>/<?= $ms['y'] ?></td>
            ...
            <div class="col-xl-5">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <?php if ($filterCat): ?>
                        <a href="<?= base_url('admin/expenses&month='.$filterMonth.'&year='.$filterYear) ?>" class="btn btn-sm btn-outline-secondary"><?= __('Bỏ lọc') ?></a>
                        <?php endif; ?>
                    </div>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0 align-middle">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <tr class="<?= $isActiveCat ? 'table-active' : '' ?>" style="cursor:pointer" onclick="location.href='<?= base_url('admin/expenses&month='.$filterMonth.'&year='.$filterYear.'&category='.urlencode($catName)) ?>'">
