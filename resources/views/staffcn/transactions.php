            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex gap-2">
                        <a href="<?= base_url('ajaxs/staffcn/transactions-export.php') ?>?type=<?= urlencode($filterType) ?>&customer_id=<?= urlencode($filterCustomer) ?>&date_from=<?= urlencode($filterDateFrom) ?>&date_to=<?= urlencode($filterDateTo) ?>" class="btn btn-success">
                            ...
                            <table class="table data-table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('staffcn/customers-detail?id=' . $txn['customer_id']) ?>"><?= htmlspecialchars($txn['customer_name'] ?? '') ?></a>
                                        </td>
