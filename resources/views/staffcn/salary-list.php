...
$staffList = $ToryHub->get_list_safe(
    "SELECT id, fullname, username, role FROM `users` WHERE `role` IN ('staffcn','finance_cn') AND `active` = 1 ORDER BY `fullname` ASC",
    []
);
...
?>
            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex gap-2">
                        <a href="<?= base_url('ajaxs/staffcn/salary-export.php') ?>?month=<?= $filterMonth ?>&year=<?= $filterYear ?>&status=<?= urlencode($filterStatus) ?>&user_id=<?= urlencode($filterStaff) ?>" class="btn btn-success">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form method="GET" action="<?= base_url('staffcn/salary-list') ?>" class="row g-3 align-items-end">
                            <div class="col-md-1">
                            ...
                            <div class="col-md-auto">
                                ...
                                <a href="<?= base_url('staffcn/salary-list') ?>" class="btn btn-secondary"><?= __('Reset') ?></a>
                            </div>
                        </form>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex gap-1 justify-content-center">
                                                ...
                                                <a href="<?= base_url('staffcn/salary-detail?id=' . $s['id']) ?>" class="btn btn-sm btn-soft-primary" title="<?= __('Sửa') ?>"><i class="ri-edit-line me-1"></i><?= __('Sửa') ?></a>
...
$(function(){
    ...
    var ajaxUrl = '<?= base_url('ajaxs/staffcn/salaries.php') ?>';
