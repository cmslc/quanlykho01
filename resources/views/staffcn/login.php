                    ...
                    <div class="card auth-card">
                        <div class="card-body p-4">
                            <div class="text-center mb-4">
                                ...
                                <h4 class="mb-1"><b><?= __('Kho Trung Quốc') ?> - ToryHub</b></h4>
