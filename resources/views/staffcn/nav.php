            ...
            <div class="d-flex">
                <div class="navbar-brand-box horizontal-logo">
                    <a href="<?= base_url('staffcn/home') ?>" class="logo logo-dark">
                        <span class="logo-lg"><b><?= __('Kho Trung Quốc') ?></b></span>
                    </a>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="<?= base_url('public/material/assets/images/users/avatar-1.jpg') ?>" alt="<?= htmlspecialchars($getUser['fullname'] ?: $getUser['username']) ?>">
