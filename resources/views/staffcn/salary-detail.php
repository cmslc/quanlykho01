...
if (!$salaryId) { header('Location: ' . base_url('staffcn/salary-list')); exit; }
...
if (!$salary) { header('Location: ' . base_url('staffcn/salary-list')); exit; }
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <a href="<?= base_url('staffcn/salary-list?month=' . $salary['month'] . '&year=' . $salary['year']) ?>" class="btn btn-light">
