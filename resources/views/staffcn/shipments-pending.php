...
?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form method="GET" action="<?= base_url('staffcn/shipments-pending') ?>">
                            <div class="row g-3 align-items-end">
                                ...
                                <div class="col-md-auto">
                                    ...
                                    <a href="<?= base_url('staffcn/shipments-pending') ?>" class="btn btn-secondary"><?= __('Reset') ?></a>
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-3">
                            ...
                            <nav>
                                <ul class="pagination pagination-sm mb-0">
                                    ...
                                    $baseUrl = base_url('staffcn/shipments-pending') . ($queryParams ? '?' . http_build_query($queryParams) : '');
                                    ?>
                    ...
                    $.post(shipmentAjaxUrl, { request_name: 'add_packages', shipment_id: res.shipment_id, package_ids: packageIds.join(','), csrf_token: csrfToken }, function(res2){
                        ...
                        if (res2.status === 'success') {
                            Swal.fire({
                                ...
                                html: res2.msg + '<br><a href="<?= base_url('staffcn/shipments-detail?id=') ?>' + res.shipment_id + '" class="btn btn-sm btn-primary mt-2"><i class="ri-eye-line me-1"></i><?= __('Xem chuyến xe') ?></a>',
