                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <?php endif; ?>
                                    <?php $rowNum = $offset; foreach ($shipments as $s): ?>
                                    <?php $cfg = $statusLabels[$s['status']] ?? $statusLabels['preparing']; $rowNum++; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-1">
                                                <a href="<?= base_url('staffcn/shipments-detail?id=' . $s['id']) ?>" class="btn btn-sm btn-soft-info"><i class="ri-eye-line me-1"></i><?= __('Xem') ?></a>
