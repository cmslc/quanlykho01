        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <a href="<?= base_url('ajaxs/staffvn/customer-detail-export.php?id=' . $id) ?>" class="btn btn-sm btn-success me-1">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><strong><?= htmlspecialchars($order['product_code'] ?? $order['order_code'] ?? '') ?></strong></td>
                                        <td>
