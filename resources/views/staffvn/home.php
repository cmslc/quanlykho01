...
$waiting_delivery = $ToryHub->get_list_safe("SELECT o.*, c.fullname as customer_name, c.phone as customer_phone
    FROM `orders` o LEFT JOIN `customers` c ON o.customer_id = c.id
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0"><?= __('Bảng điều khiển') ?> - <?= __('Kho Việt Nam') ?></h4>
                </div>
            </div>
        </div>
