            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <form method="GET" action="<?= base_url('staffvn/finance-summary') ?>" class="d-flex gap-2 align-items-center">
                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <a href="<?= base_url('staffvn/transactions') ?>" class="btn btn-sm btn-soft-info"><?= __('Xem tất cả') ?></a>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="<?= base_url('staffvn/customers-detail?id=' . $tx['customer_id']) ?>"><?= htmlspecialchars($tx['customer_name']) ?></a>
                                            <?php else: ?>
                                            <span class="text-muted">-</span>
                                            <?php endif; ?>
                                        </td>
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?= $idx + 1 ?></td>
                                        <td>
                                            <a href="<?= base_url('staffvn/customers-detail?id=' . $tc['id']) ?>">
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <a href="<?= base_url('staffvn/transactions') ?>" class="btn btn-sm btn-soft-info"><?= __('Chi tiết') ?></a>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <a href="<?= base_url('staffvn/expenses') ?>" class="btn btn-sm btn-soft-warning"><?= __('Chi tiết') ?></a>
                    </div>
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-2">
                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <a href="<?= base_url('staffvn/salary-list') ?>" class="btn btn-sm btn-soft-primary"><?= __('Chi tiết') ?></a>
                    </div>
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-2">
                ...
                <div class="card border-danger">
                    <div class="card-header bg-danger text-white d-flex align-items-center justify-content-between">
                        ...
                        <a href="<?= base_url('staffvn/debt-list') ?>" class="btn btn-sm btn-light"><?= __('Xem tất cả') ?></a>
                    </div>
                    <div class="card-body p-0">
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <a href="<?= base_url('staffvn/customers-detail?id=' . $dc['id']) ?>" class="list-group-item list-group-item-action">
