<?php
/**
 * Export salary list to XLSX (PhpSpreadsheet)
 */
define('IN_SITE', true);
...
// Title
$sheet->setCellValue("A{$row}", __('BẢNG LƯƠNG NHÂN VIÊN') . " — " . __('Tháng') . " {$filterMonth}/{$filterYear}");
...
// Output
$filename = "Luong_T{$filterMonth}_{$filterYear}.xlsx";
