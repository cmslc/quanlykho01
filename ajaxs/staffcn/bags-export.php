...
// Header row
$headers = ['STT', 'Mã bao', 'Trạng thái', 'Số kiện', 'Tổng cân (kg)', 'Số khối (m³)', 'Người tạo', 'Ngày tạo', 'Ảnh 1'];
...
$imgPx = 80;
$rowHeightPt = intval($imgPx / 0.75) * 0.75 + 10;
...
// Add headers for extra image columns
$maxImgCols = 5;
