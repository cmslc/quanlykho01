...
if ($request === 'add') {
    ...
    $volume_actual = floatval(input_post('volume_actual'));
    ...
    $insertResult = $ToryHub->insert_safe("orders", [
        ...
        'volume_actual' => $volume_actual > 0 ? $volume_actual : null,
...
if ($request === 'edit') {
    ...
    $edit_volume_actual = floatval(input_post('volume_actual'));
    ...
    $ToryHub->update_safe("orders", [
        ...
        'volume_actual' => $edit_volume_actual > 0 ? $edit_volume_actual : null,
